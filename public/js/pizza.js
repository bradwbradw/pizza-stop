...
function Pizza() {
  ...
  var Pizza = this;
    ...
    selectedSorting: ko.observable(load('selectedSorting')),
  ...
  var saving = 'livePrices key exchangeSlices trades user selectedSorting'.split(' ');
